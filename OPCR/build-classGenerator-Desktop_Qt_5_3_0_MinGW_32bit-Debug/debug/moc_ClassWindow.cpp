...
#include "../../ClassGenerator/ClassWindow.h"
...
struct qt_meta_stringdata_ClassWindow_t {
    QByteArrayData data[4];
    char stringdata[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassWindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClassWindow_t qt_meta_stringdata_ClassWindow = {
    {
...
QT_MOC_LITERAL(3, 23, 7)
    ...
    "ClassWindow\0addCppTab\0\0saveCpp"
};
...
void ClassWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->addCppTab(); break;
        case 1: _t->saveCpp(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ClassWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ClassWindow.data,
      qt_meta_data_ClassWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ClassWindow.stringdata))
